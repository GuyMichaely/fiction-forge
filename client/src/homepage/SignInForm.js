...
export default function SignInPage() {
  ...
  return (
    <form className="mx-auto top-0 absolute left-4 h-12 w-80 bg-white shadow-md rounded px-8 pt-6 pb-64">
      <p className="text-sm mb-2 text-gray-700 block font-bold underline">Login/Register</p>
      <div className="mb-4">
        <label
